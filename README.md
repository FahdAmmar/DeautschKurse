...
### منصة موحّدة تربط ٧٥ درسًا تفاعليًا في اللغة الألمانية ضمن مسار تعليمي واحد
...
كل درس من الـ٧٥ درسًا في هذه المكتبة صُمِّم بشكل **مستقل تمامًا** — خطوطه وألوانه
...
Deutsch/
  a1/                            المرحلة A1 — نقطة الانطلاق (٩ دروس)
  a2-kurs/                       مسار A2 الكامل — ١٢ درسًا متسلسلًا
  a2/                            أدلة A2 الشاملة (١١ دليلًا عميقًا)
  grammatik/                     مرجع القواعد الكامل (٢٣ مرجعًا)
  family-verben/                  عائلات الأفعال (٨ دروس)
